...
$(btn_get_script_from_other_device).click(function() {
    editor.setValue(scriptState['activeScriptCode']);
    $('#model_script_running').modal('hide');
   
});

$(btn_script_from_other_device_abort).on( "click", function() {
    $('#model_script_running').modal('hide');
     _showScriptRobot();
});


$(btn_modal_script_delete).click(function() {
...
$(btn_dropdown_script_save).click(function() {

    $(btn_modal_script_save).prop("disabled",true);
    $('#modal_script_save').modal('show');
});

$(btn_script_upload_local).click(function() {
...
$(btn_modal_script_save).click(function() {
...
$("#txt_script_save_filename").change(function(){
