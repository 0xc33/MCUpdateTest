class OrbitControlsGizmo {
    ...
    function createAxes () {
      ...
      return [
        ...
        { axis: "z", direction: new THREE.Vector3(0, 0, 1), size: size.primary, color: colors.z, line, label: "Y", position: new THREE.Vector3(0, 0, 0)  },
        { axis: "y", direction: new THREE.Vector3(0, 1, 0), size: size.primary, color: colors.y, line, label: "Z", position: new THREE.Vector3(0, 0, 0)  },
